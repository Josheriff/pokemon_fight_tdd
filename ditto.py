ditto = {
    ...
    'moves': [{
          ...
          'version_group_details': [{
                ...
                'level_lea
                (venv) zMacPro - Master: pokemon_fight_tdd JMGallego$ python inyeccion_dependencias.py
                4
                6 {
                  'abilities': [{
                        'ability': {
                        ...
                        limber ', '
                        url ': '
                        https: //pokeapi.co/api/v2/ability/7/'}, 'is_hidden': False, 'slot': 1}], 'base_experience': 101, 'forms'
                          : [{
                            'name': 'ditto',
                            'url': 'https://pokeapi.co/api/v2/pokemon-form/132/'
                          }],
                        'game_indices': [{
                              ...
                              'version': {
                                ...
                                hite - 2 ', '
                                url ': '
                                https: //pokeapi.co/api/v2/version/22/'}}, {'game_index': 132, 'version': {'name': 'black-2', 'url': 'https://pokeapi.co
                                  /api/v2 / version / 21 / '}}, {'
                                game_index ': 132, '
                                version ': {'
                                name ': '
                                white ', '
                                url ': '
                                https: //pokeapi.co/api/v2/version/18/'}}, {'game_index'
                                  : 132,
                                'version': {
                                  'name': 'black',
                                  'url': 'https://pokeapi.co/api/v2/version/17/'
                              ...
                              },
                              {
                                ...
                                'version': {
                                  ...
                                  r ', '
                                  url ': '
                                  https: //pokeapi.co/api/v2/version/16/'}}, {'game_index': 132, 'version': {'name': 'heartgold', 'url': 'https://pokeapi.co/ap
                                    i / v2 / version / 15 / '}}, {'
                                  game_index ': 132, '
                                  version ': {'
                                  name ': '
                                  platinum ', '
                                  url ': '
                                  https: //pokeapi.co/api/v2/version/14/'}}, {'game_index'
                                    : 132,
                                  'version': {
                                    'name': 'pearl',
                                    'url': 'https://pokeapi.co/api/v2/version/13/'
